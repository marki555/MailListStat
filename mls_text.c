...
// fprintf(fOut,"+----+----%s-----------------------------------------+-Percent-+\n",langGAuthor[lang]);
   ...
   fprintf(fOut,"\n");
   fprintf(fOut,"***** Generated by MailListStat v%s, (C) 2001-2003\n",VERSION);
   fprintf(fOut,"***** See https://github.com/marki555/MailListStat for details...\n");
...
// fprintf(fOut,"<td>&nbsp;<td>&nbsp;%s&nbsp;<td>&nbsp;Percent&nbsp;\n",langGAuthorHtml[lang]);
   ...
   fprintf(fOut,"<td align=\"right\">Generated by <a href=\"https://github.com/marki555/MailListStat\"><b>MailListStat</b></a> v%s\n",VERSION);
   fprintf(fOut,"</TABLE>\n");
